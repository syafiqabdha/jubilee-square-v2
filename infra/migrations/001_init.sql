...
VALUES
    ...
    ('b0000000-0000-0000-0000-000000000014', 'c0000000-0000-0000-0000-000000000002', 'my-drum-school', 'My Drum School', 'L4', '#04-04/05', 'Specialized drum education with modern facilities, certified instructors, and customized syllabi.', 'Singapore premier drum-only music academy. Equipped with state-of-the-art acoustic drum studios, customized digital tracking syllabus, Rockschool examination certification, and live performance opportunities.', '+65 6464 0123', '+65 9345 9012', 'amk@mydrumschool.com', 'https://mydrumschool.com', '/images/tenants/mydrumschool-logo.png', '/images/tenants/mydrumschool-hero.jpg', ARRAY['drums', 'percussion', 'music school', 'rockschool', 'drum lessons'], '{"facility": "Acoustic Soundproof Studios", "curriculum": "MDS Proprietary Drum Syllabus", "exam_board": "Rockschool UK"}'::jsonb, TRUE, 14),
...
VALUES
    ('f0000000-0000-0000-0000-000000000001', 'Welcome to Jubilee Square AMK', 'image', '/images/signage/welcome-banner.jpg', 12, ARRAY['all']::TEXT[], NULL, 'Welcome to Jubilee Square', 'Your Community Dining, Learning & Wellness Destination in AMK', TRUE, 1),
    ('f0000000-0000-0000-0000-000000000002', 'Level 3 & 4 Education Hub Spotlight', 'image', '/images/signage/education-spotlight.jpg', 15, ARRAY['L1_lift', 'L1_counter', 'L3_lift', 'L4_lift']::TEXT[], NULL, 'Explore Top Enrichment Centres on Levels 3 & 4', 'My Drum School • AGrader • LCentral • Jeong-In Taekwondo • Wang Learning', TRUE, 2),
    ('f0000000-0000-0000-0000-000000000003', 'Bantianyao Grilled Fish Featured', 'image', '/images/signage/bantianyao-slide.jpg', 10, ARRAY['L1_counter', 'L2_lift', 'L2_escalator']::TEXT[], 'b0000000-0000-0000-0000-000000000001', 'Sizzling Sichuan Flavors on Level 2 (#02-01)', 'Rattan Pepper Grilled Fish & Unlimited Buffet Counter', TRUE, 3),
    ('f0000000-0000-0000-0000-000000000004', 'Level 2 Wellness & Hair Studios', 'image', '/images/signage/wellness-slide.jpg', 10, ARRAY['L2_lift', 'L2_escalator']::TEXT[], NULL, 'Recharge on Level 2', 'Ashi Foot Reflexology • 7 Studio Hair Salon • Skin Labo • Glow Haven', TRUE, 4),
    ('f0000000-0000-0000-0000-000000000005', 'Wayfinding & Interactive Directory Map', 'html', '/signage/wayfinding-kiosk', 20, ARRAY['L1_lift', 'L2_lift', 'L3_lift', 'L4_lift', 'L3_ceiling']::TEXT[], NULL, 'Digital Directory & Floor Wayfinding', 'Touch screen or view full floor layout on your mobile phone', TRUE, 5)
